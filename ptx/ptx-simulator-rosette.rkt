...
(require "../simulator-rosette.rkt" "../ops-rosette.rkt" "../inst.rkt" "ptx-machine.rkt")
(provide ptx-simulator-rosette%)

(define ptx-simulator-rosette%
  (class simulator-rosette%
    (super-new)
    (init-field machine)
    (override interpret performance-cost get-constructor)

    (define (get-constructor) ptx-simulator-rosette%)
